...
# Load the meet rosters generated by Json_Team_Parser.py
try:
    with open('save.txt', 'r') as f:
        Meet = json.load(f)
except FileNotFoundError:
    print("Error: save.txt not found! Run Json_Team_Parser.py first to generate it.")
    exit(1)
except json.JSONDecodeError:
    print("Error: save.txt is not valid JSON!")
    exit(1)
